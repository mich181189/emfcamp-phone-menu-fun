    ...
    res.json([
                {
                    ...
                    "Wind is blowing from the " + windDir(lastWeather.winddir) + " at " + roundNum1(lastWeather.windspeed*1.60934) + " kilometers per hour" + " with gusts of " + roundNum1(lastWeather.windgust*1.60934) + " kilometers per hour. " +
